...
const DISCUSSION_PROMPTS = [
  'まわりにある このいろの ものを さがしてみよう！ 🔍',
  'みんなの いちばん すきな いろは なーんだ？ 🎨',
  'このいろの たべもの（くだものや おやさい）には なにがあるかな？ 🍎',
  'このいろの おようふくや おもちゃは もっているかな？ 🧸',
  'このいろを みると、どんな きぶんになる？ 😊',
  'どうぶつや おはなで、このいろの ものは なにがいるかな？ 🦁🌸',
  'そらや うみ、おうちの なかに、このいろは あるかな？ ☁️🏡',
